...
export default forwardRef(function TextInput({
  ...
  const styleEnable = `border-gray-300 dark:border-gray-500 focus:border-light-primary focus:ring-light-primary dark:focus:border-dark-primary dark:focus:ring-dark-primary rounded-md shadow-sm bg-slate-50 dark:bg-gray-800 text-light-txt dark:text-dark-txt`;
